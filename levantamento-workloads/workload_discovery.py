...
# Lista de contas membro a serem levantadas.
# Adicione uma entrada por conta. O "name" é usado no nome do arquivo de saída.
ACCOUNTS = [
...
# Regiões AWS a varrer em cada conta.
...
# O script testa cada role e usa a primeira que funcionar.
# Adicione ou remova conforme o padrão de acesso do cliente.
ROLE_CANDIDATES = [
...
def main():
    ...
    if not ACCOUNTS or ACCOUNTS[0]["id"] in ("111111111111", "222222222222"):
        ...
        print("Exemplo:")
        print('  ACCOUNTS = [')
        print('      {"id": "123456789012", "name": "nome-da-conta"},')
        print('  ]')
        return
